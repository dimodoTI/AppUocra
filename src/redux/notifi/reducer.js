import { GET_NOTIFICACION, GET_NOTIFICACION_SUCCESS, GET_NOTIFICACION_ERROR, GET_SUCCESS, GET_ERROR, PATCH_SUCCESS, PATCH_ERROR, UPDATE_SUCCESS, UPDATE_ERROR, ADD_SUCCESS, ADD_ERROR, REMOVE_SUCCESS, REMOVE_ERROR, EDIT, SET, PRENDE_NOTIFICACION, APAGA_NOTIFICACION, MOSTRAR_NOTIFICACIONES } from "./actions";
...
export const reducer = (state = initialState, action) => {
	...
	switch (action.type) {
		...
		case MOSTRAR_NOTIFICACIONES:
			newState.mostrarNotificaciones = action.ver;
			break;
	}
	return newState;
};
